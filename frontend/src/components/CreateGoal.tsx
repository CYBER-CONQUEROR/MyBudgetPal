...
interface CreateGoalProps {
  onCreateGoal: (goal: Omit<SavingsGoal, 'id' | 'currentAmount' | 'deposits' | 'createdDate'>) => void;
  onClose: () => void;
  existingGoals: SavingsGoal[];
}

export const CreateGoal: React.FC<CreateGoalProps> = ({ onCreateGoal, onClose, existingGoals }) => {
