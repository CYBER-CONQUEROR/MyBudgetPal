...
/**
 * @typedef {Object} GoalDetailsProps
 * @property {Object} goal - The savings goal object
 * @property {function} onBack - Function to go back to goals list
 * @property {function} onAddDeposit - Function to add a deposit
 * @property {function} onUpdateGoal - Function to update the goal
 * @property {function} [onEditGoal] - Function to edit the goal
 * @property {function} [onDeleteGoal] - Function to delete the goal
 */

/**
 * Detailed view component for a specific savings goal
 * @param {GoalDetailsProps} props
 */
