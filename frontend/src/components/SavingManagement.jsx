...
/**
 * Main savings management component that handles all goal-related operations
 */
export const SavingManagement = () => {
  const [goals, setGoals] = useLocalStorage('savings-goals', []);
  ...
  const handleAddDeposit = (goalId, depositData) => {
    const deposit = {
      ...depositData,
      id: crypto.randomUUID()
    };
