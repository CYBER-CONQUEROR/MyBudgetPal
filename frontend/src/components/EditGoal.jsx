...
/**
 * @typedef {Object} EditGoalProps
 * @property {Object} goal - The goal to edit
 * @property {function} onUpdateGoal - Function to handle goal updates
...
/**
 * Modal component for editing existing savings goals
 * @param {EditGoalProps} props
 */
export const EditGoal = ({ goal, onUpdateGoal, onClose, existingGoals }) => {
