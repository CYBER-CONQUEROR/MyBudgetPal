...
import { Plus, X, DollarSign, Calendar, Target } from 'lucide-react';
import { calculateSavingsTargets } from '../utils/calculations';
import { validateGoalForm } from '../utils/validations';
import { FormField } from './FormField';

/**
 * @typedef {Object} CreateGoalProps
 * @property {function} onCreateGoal - Function to handle goal creation
 * @property {function} onClose - Function to close the modal
 * @property {Array} existingGoals - Array of existing goals for duplicate checking
 */

/**
 * Modal component for creating new savings goals
 * @param {CreateGoalProps} props
 */
export const CreateGoal = ({ onCreateGoal, onClose, existingGoals }) => {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {preview && (
            <div className="bg-blue-50 rounded-lg p-4 space-y-2">
              <h3 className="font-semibold text-blue-900 mb-2">Savings Plan Preview</h3>
