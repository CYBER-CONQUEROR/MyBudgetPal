...
const getTransactions = () => axios.get(API);
const createTransaction = (data) => axios.post(API, data);
const updateTransaction = (id, data) => axios.put(`${API}/${id}`, data);
const deleteTransaction = (id) => axios.delete(`${API}/${id}`);
